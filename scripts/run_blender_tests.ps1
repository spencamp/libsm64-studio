...
try {
    ...
    foreach ($name in @("__init__.py", "mario.py", "audio_runtime.py", "collision_cache.py", "recording.py", "take_manager.py", "input_reader.py", "input_reader_win.py", "collision_types.py", "zeth_inputs.py")) {
