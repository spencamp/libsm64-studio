...
required_stages = [
    ...
    "before_surface_object_create_initial_1",
    "after_surface_object_create_initial_1",
    "before_surface_object_create_initial_2",
    "after_surface_object_create_initial_2",
    "before_mario_create",
    "after_mario_create",
    "before_mario_tick",
    "after_mario_tick",
    "before_surface_object_create_incoming",
    "after_surface_object_create_incoming",
    "before_surface_object_delete_distant",
    "after_surface_object_delete_distant",
    "before_mario_tick_after_stream",
    "after_mario_tick_after_stream",
    "before_surface_object_delete_remaining_1",
    "after_surface_object_delete_remaining_1",
    "before_surface_object_delete_remaining_2",
    "after_surface_object_delete_remaining_2",
    "before_mario_delete",
    "after_mario_delete",
